...
import { MdEventNote, MdOutlineVerifiedUser, MdOutlineWifiCalling3 } from "react-icons/md";
...
const Header = () => {
    return (
        <>
            ...
            <div className=' h-20 absolute w-full top-0 flex justify-around p-4 b '>

                <div><img className=' w-28' src={IEEE} alt="" /></div>



                <div className=' w-fit border-2 border-white text-white  rounded-xl  lg:flex hidden justify-around items-center p-2' >
                ...
                <div className=' w-fit border-2 border-white text-white  rounded-xl  justify-around items-center p-2 flex  lg:hidden' >
                ...
                <Link to='/contact' className='text-white  border-2 hidden border-white rounded-xl  lg:flex justify-around items-center p-2 cursor-pointer hover:bg-white/40  transition-all' >
                    Contact Us
